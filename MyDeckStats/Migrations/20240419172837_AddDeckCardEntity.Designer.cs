...
namespace MyDeckStats.Migrations
{
    ...
    [Migration("20240419172837_AddDeckCardEntity")]
    partial class AddDeckCardEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyDeckStats.Domain.Entities.Mtg.Decks.Deck", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MyDeckStats.Domain.Entities.Mtg.Decks.DeckCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MyDeckStats.Domain.Entities.Mtg.Decks.Deck", b =>
                {
                    b.HasOne("MyDeckStats.Domain.Entities.Mtg.Decks.Format", "Format")
                        .WithMany()
                        .HasForeignKey("FormatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyDeckStats.Domain.Entities.Mtg.Decks.Guild", "Guild")
                        .WithMany()
                        .HasForeignKey("GuildId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyDeckStats.Domain.Entities.Mtg.Cards.MtgCard", "Card")
                        .WithMany()
                        .HasForeignKey("MtgCardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyDeckStats.Domain.Entities.Mtg.Decks.DeckCard", b =>
                {
                    b.HasOne("MyDeckStats.Domain.Entities.Mtg.Decks.Deck", "Deck")
                        .WithMany()
